...
/**
 * @ORM\Entity(repositoryClass=HarvestPeriodRepository::class)
 */
class HarvestPeriod
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Seed::class, mappedBy="harvestPeriod")
     */
    private $seeds;
